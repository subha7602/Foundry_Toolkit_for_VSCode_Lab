...
"""
Explain Like I'm an Executive Agent - Powered by Google Gemini.
...
def run_agent(user_input: str) -> str:
    ...
    if msg.tool_calls:
        ...
        final_resp = client.chat.completions.create(model=GEMINI_MODEL, messages=messages)
...
def start_server(host="127.0.0.1", port=8088):
    ...
    print("=" * 70)
    print(f"Gemini Agent Server running on http://{host}:{port}")
